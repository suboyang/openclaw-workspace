#!/usr/bin/env python3
"""
Qwen3-TTS 1.7B CustomVoice 語音生成腳本
用法: python tts_only_1.7B.py "文字檔案" "輸出.wav"
"""
...
MODEL_PATH = "/home/openclaw/.cache/models/qwen-tts-1.7B-CustomVoice"
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("用法: python tts_only_1.7B.py <文字檔案> <輸出.wav>")
        sys.exit(1)
