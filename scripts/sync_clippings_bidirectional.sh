...
LOG_FILE="/home/openclaw/.openclaw/workspace/tmp/sync_clippings_watch.log"
PID_FILE="/home/openclaw/.openclaw/workspace/tmp/sync_clippings_watch.pid"
POLL_INTERVAL=10

# Explicit exclude list (more reliable than .gitignore on network fs)
EXCLUDE=(
    --exclude='venv/'
    --exclude='.venv/'
    --exclude='__pycache__/'
...
while true; do
    ...
    # inotify for local workspace changes (works fine on local fs)
